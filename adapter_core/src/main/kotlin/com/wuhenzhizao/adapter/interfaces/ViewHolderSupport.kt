...
interface ViewHolderSupport {
     ...
     * @return T: subclass of ViewHolderSupport.
     */
    fun <T : ViewHolderSupport> T.setOnClickListener(@IdRes viewId: Int, block: (v: View) -> Unit): T {
        val view = getView<View>(viewId)
     ...
     * @return T: subclass of ViewHolderSupport.
     */
    fun <T : ViewHolderSupport> T.setOnTouchListener(@IdRes viewId: Int, block: (v: View, event: MotionEvent) -> Boolean): T {
        val view = getView<View>(viewId)
     ...
     * @return T: subclass of ViewHolderSupport.
     */
    fun <T : ViewHolderSupport> T.setOnLongClickListener(@IdRes viewId: Int, block: (v: View) -> Boolean): T {
        val view = getView<View>(viewId)
     ...
     * @return T: subclass of ViewHolderSupport.
     */
    fun <T : ViewHolderSupport> T.setOnCheckedChangeListener(@IdRes viewId: Int, block: (buttonView: CompoundButton, isChecked: Boolean) -> Unit): T {
